 ...
 * The PLL hardware has a minimum frequency of 384MHz to 1512MHz. The L_VALs
...
static struct clkctl_l2_speed l2_freq_tbl_v2[] = {
	...
	[21] = {1512000,  1, 0x1C, 1225000, 1250000, 3},
	[22] = {1566000,  1, 0x1D, 1225000, 1250000, 3},
};
...
static struct clkctl_acpu_speed acpu_freq_tbl_oc[] = {
  ...
  { {1, 1}, 1728000,  ACPU_SCPLL, 0, 0, 1, 0x1C, L2(21), 1275000, 0x03006000},
  { {1, 1}, 1782000,  ACPU_SCPLL, 0, 0, 1, 0x1D, L2(21), 1300000, 0x03006000},
  { {0, 0}, 0 },
};
...
{
	char *p = page;
	p += sprintf(p, "1.5 GHz x2 - D.I.R.T y MAC"); 
	return p - page;
}
